...
- [`make.R`](https://github.com/slarge/causal/tree/main/make.R):
main R script to run the entire project

- [`R/`](https://github.com/slarge/causal/tree/main/R):
...
check out our [Contributor Guidelines](https://github.com/slarge/causal/blob/main/CONTRIBUTING.md).
